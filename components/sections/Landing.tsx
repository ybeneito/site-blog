export default function Landing() {
    return (
        ...
        <p className="mt-10 text-neutral-500 my-2 text-start">
        ...
        <p className="mt-10 text-neutral-500 my-2 text-lg text-start">
          Après une première carrière en tant que <span className="text-primary">cuisinier</span> , je me suis rendu compte que ce métier ne correspondait pas entièrement à les attentes.  
        </p>
        <p className="mt-10 text-neutral-500 my-2 text-lg text-start">
